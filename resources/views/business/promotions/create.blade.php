...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color: pink">{{ __('Create Promotion') }}</div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="product_service_name" type="text" class="form-control"
                                        name="product_service_name" value="{{ old('product_service_name') }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="target_audience" type="text"
                                        ...
                                        name="target_audience" value="{{ old('target_audience') }}" required>
